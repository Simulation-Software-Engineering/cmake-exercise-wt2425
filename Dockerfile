...
RUN cd /usr/local/src && git clone https://github.com/bergdola/cmake-exercise-wt2223.git && cd /usr/local/src/cmake-exercise-wt2223 && mkdir build && cd build && cmake .. && make ./cmake-ex-bergdola && ./cmake-ex-bergdola /usr/local/src/cmake-exercise-wt2223/yamlParser/config.yml
